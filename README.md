...
2. Каждый вопрос имеет четыре варианта ответа, один из которых правильный

3. Вопросы установлены для четырех квалификационных категорий. 
